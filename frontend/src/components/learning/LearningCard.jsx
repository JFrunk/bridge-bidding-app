...
export function LearningCard({ rank, suit, size = 'medium', className = '' }) {
  ...
  return (
    <div className={`learning-card ${size} ${colorClass} ${className}`}>
      {/* Top-left corner */}
 ...
 * @param {string} props.size - Size variant for cards
 */
export function LearningHand({ cards, size = 'medium' }) {
