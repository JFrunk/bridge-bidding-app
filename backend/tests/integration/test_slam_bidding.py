...
class TestSlamBiddingRequirements:
...
class TestBlackwoodConvention:
    ...
    def test_blackwood_responses_correct(self):
        ...
        # Auction: 1♥ - Pass - 4NT (Blackwood) - Pass - ?
        auction = ['1♥', 'Pass', '4NT', 'Pass']
        ...
        # Should respond 5♥ (2 aces)
        assert bid == '5♥', (
            f"Responding to Blackwood with 2 aces, bid {bid}! "
            f"Should bid 5♥ (2 aces)."
        )
...
class TestSlamEvaluation:
    ...
    def _create_blackwood_scenario_hands(self):
        ...
        # Opener with 18 HCP, good hearts
        opener_cards = [
            Card('A', '♠'), Card('K', '♠'), Card('Q', '♠'),
            Card('A', '♥'), Card('K', '♥'), Card('Q', '♥'),
            Card('J', '♥'), Card('T', '♥'),
        ...
        # Responder with 12 HCP, heart fit
        responder_cards = [
            Card('J', '♠'), Card('T', '♠'),
