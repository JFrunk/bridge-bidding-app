"""
Simple Rule-Based AI for Card Play (Phase 1)

This is a rule-based AI that uses traditional bridge heuristics.
Good for learning and as a baseline for comparison with advanced AIs.
...
- Trumping: Trump when opponents winning
"""
...
class SimplePlayAI(BasePlayAI):
    """
    Rule-based AI for card play - Phase 1

    Uses traditional bridge playing heuristics without any look-ahead search.
    Fast and predictable, suitable for beginner-level play.
    """
    ...
    def choose_card(self, state: PlayState, position: str) -> Card:
        """
        Choose a card using rule-based heuristics
